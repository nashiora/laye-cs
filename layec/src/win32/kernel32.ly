...
extern "kernel32" stdcall i32 WriteConsoleA(i32 hConsoleOutput, u8 readonly[*]lpBuffer, i32 nNumberOfCharsToWrite, rawptr lpNumberOfCharsWritten, rawptr lpReserved);

//http://alter.org.ua/en/docs/win/args/
extern "kernel32" stdcall u8 [*]GetCommandLineA();
