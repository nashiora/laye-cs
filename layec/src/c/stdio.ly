...
extern "C" rawptr fopen(u8 [*]filename, u8 [*]mode);
extern "C" u32 fread(rawptr ptr, u32 size, u32 nmemb, rawptr stream);
extern "C" rawptr freopen(u8 [*]filename, u8 [*]mode, rawptr stream);
...
extern "C" i32 remove(u8 [*]filename);
extern "C" i32 rename(u8 [*]old_filename, u8 [*]new_filename);
...
extern "C" i32 fprintf(rawptr stream, u8 [*]format, varargs);
extern "C" i32 printf(u8 [*]format, varargs);
extern "C" i32 sprintf(u8 [*]str, u8 [*]format, varargs);
//extern "C" i32 vfprintf(rawptr stream, u8 [*]format, va_list arg);
//extern "C" i32 vprintf(u8 [*]format, va_list arg);
//extern "C" i32 vsprintf(u8 [*]str, u8 [*]format, va_list arg);
extern "C" i32 fscanf(rawptr stream, u8 [*]format, varargs);
extern "C" i32 scanf(u8 [*]format, varargs);
extern "C" i32 sscanf(u8 [*]str, u8 [*]format, varargs);
extern "C" i32 fgetc(rawptr stream);
extern "C" u8 [*]fgets(u8 [*]str, i32 n, rawptr stream);
extern "C" i32 fputc(i32 char, rawptr stream);
extern "C" i32 fputs(u8 [*]str, rawptr stream);
...
extern "C" i32 puts(u8 [*]str);
extern "C" i32 ungetc(i32 char, rawptr stream);
extern "C" void perror(u8 [*]str);